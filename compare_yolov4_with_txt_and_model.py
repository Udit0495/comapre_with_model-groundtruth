...
for image in os.listdir(img_dir):
     ...
     for box in boxes:
         ...
         cv2.putText(img, f'{name}', (x1,y1), cv2.FONT_HERSHEY_PLAIN, 2, (0,0,255), 3, cv2.LINE_AA)
    ...
    try:
        with open('./labels/'+name+'.txt', 'r') as file:
            ...
            for line in  file:
                ...
                cv2.putText(image, f'{name}', (x1,y1), cv2.FONT_HERSHEY_PLAIN, 2, (255,0,0), 3, cv2.LINE_AA)
